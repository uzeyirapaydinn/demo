...
namespace QuickCode.Demo.Portal.Models.UserManagerModule
{
    public class ApiMethodDefinitionsData
    {
        ...
        public ApiMethodDefinitionsObj SelectedItem { get; set; }

        public Dictionary<string, IEnumerable<SelectListItem>> ComboList = new Dictionary<string, IEnumerable<SelectListItem>>();
        public List<ApiMethodDefinitionsObj> List { get; set; }
    }

    public class ApiMethodDefinitionsObj : ApiMethodDefinitionsDto
    {
